DROP DATABASE IF EXISTS offer_downDB;
CREATE DATABASE offer_downDB;
USE offer_downDB;
...
data validation
product details(go over)

keep track of pending offers and each product has form other user
